...
if(NOT Git_FOUND)
	message(FATAL_ERROR "Could not find 'git' tool for RP2040-HAT-SOUND-C patching")
endif()

message("RP2040-HAT-SOUND-C patch utils found")

set(RP2040_HAT_SOUND_C_SRC_DIR "${CMAKE_CURRENT_SOURCE_DIR}")
set(IOLIBRARY_DRIVER_SRC_DIR "${RP2040_HAT_SOUND_C_SRC_DIR}/libraries/ioLibrary_Driver")
...
execute_process(COMMAND ${GIT_EXECUTABLE} -C ${RP2040_HAT_SOUND_C_SRC_DIR} submodule update --init)
